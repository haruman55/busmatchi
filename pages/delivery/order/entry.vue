...
outlined prepend-icon="mdi-human-female-dance" :title="guide.guideName" :subtitle="guide.contact" color="background"
    ...
    <v-row>
      <v-col col="12">
        <v-card  flat rounded="xl" class="color-outline"  color="background">
          <v-container fluid>
            ...
            <v-row>
              ...
              <v-col cols="12" sm="6" md="6">
                <v-card flat rounded="xl" class="color-outline"  variant="outlined"  >
...
v-model="paymentDueDate" :teleport="true" locale="jp" auto-apply
    ...
    <v-row justify="center" no-gutters>
      ...
      <v-col align="center">
        <v-btn
v-if="orderInfo.state == $Const.STATUS_REQUEST" rounded dark color="secondary" size="large"  class="mb-2 pr-8 pl-8"
          @click="deny">
          運送手配を断る
        </v-btn>
      </v-col>
